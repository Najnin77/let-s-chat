...
import 'package:lets_chat/features/user/presentation/pages/inital_profile_submit_page.dart';
import 'package:lets_chat/features/user/presentation/pages/otp_page.dart';
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  const Text(
                    "Let's Chat will send you SMS message (carrier charges may apply) to verify your phone number. Enter the country code and phone number",
