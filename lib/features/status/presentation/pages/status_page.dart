...
import 'package:lets_chat/features/app/global/date/date_formats.dart';
import 'package:lets_chat/features/app/global/widgets/profile_widget.dart';
import 'package:lets_chat/features/app/global/widgets/show_image_and_video_widget.dart';
...
import 'package:lets_chat/features/status/presentation/widgets/status_dotted_borders_widget.dart';
                  ...
                  return BlocBuilder<GetMyStatusCubit, GetMyStatusState>(
                    builder: (context, state) {
                      if (state is GetMyStatusLoaded) {
                        return _bodyWidget(
                            statuses, currentUser, myStatus: state.myStatus);
                      }
